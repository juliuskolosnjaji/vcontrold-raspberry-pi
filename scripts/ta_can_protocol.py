...
# per candump gegen echte Hardware verifiziert -- unabhängig von der oben spekulativen
# Block-Kodierung (encode/decode_analog_block, nie an echter Hardware bestätigt). Die UVR sendet
# NUR bei Wertänderung > "Sendebedingung"-Schwelle bzw. spätestens nach der "Intervallzeit"
# (auf der UVR pro Ausgang konfigurierbar), nicht periodisch fix. Alle Ausgänge teilen sich EINE
# CAN-ID, unterschieden per Byte 1 (Ausgangsnummer-1). Vier unabhängige Testwerte (inkl. negativ)
# bestätigten die Formel exakt: Byte0=0x02 markiert diesen Frame-Typ (ein zweiter, hier
# irrelevanter Frame-Typ mit Byte0=0x01 wurde ebenfalls beobachtet, vermutlich Status/Digital),
# Byte1=Ausgangsnummer-1 (0-basiert), Byte2=0x01 (bei allen Beobachtungen konstant, vermutlich
# Mess-/Einheitentyp, z.B. 1="Temperatur"), Byte3=0x00 (reserviert/ungenutzt), Byte4-7=Wert als
# 4-Byte signed Little-Endian, /10 skaliert (dieselbe Formel wie im 0x4FF4-Datensatz).
